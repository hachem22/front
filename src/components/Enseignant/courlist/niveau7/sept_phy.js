...
function sept_phy() {
    ...
    useEffect(() => {
      ...
      fetch("http://localhost:3000/cours/7éme/Physique")
...
<div>
        ...
        <h1 style={{ marginBottom: '-4rem',marginTop:'6rem' }}>Playlist des cours de physique de 7ème année</h1>
