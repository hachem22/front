...
import './neuvième.css'; // Importez le fichier CSS
...
function huitiéme() {
  ...
  useEffect(() => {
      ...
      fetch("http://localhost:3000/cours/9éme/Informatique")
    ...
    <div className="Navbarr">
        <Navbar bg="light" data-bs-theme="light" style={{height:'70px', borderRadius:'15px'}}>
            ...
            <Container>
                ...
                <Nav.Link as={Link} to="/neuvième_math" >math</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_physique">physique</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_technique">technique</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_informatique">informatique</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_francais">francais</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_anglais">anglais</Nav.Link>
                    <Nav.Link as={Link} to="/neuvième_arabe">arabe</Nav.Link>
                </Nav>
               
            </Container>
        </Navbar>
    </div>
    <h1 style={{marginBottom:'-3rem'}}>Playlist des cours de informatique de 9ème année</h1>
