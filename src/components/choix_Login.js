...
<div>
  <CustomNavbar/>
      ...
      <div className="login-page-mobile-img">
        ...
        style={{ width: '35rem', height: '45rem', marginLeft: '2rem', marginTop: '-2rem' }}
      
    alt="Mobile" className="animated-image" />
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <h2 style={{marginLeft:'8rem', marginBottom:'1rem',marginTop:'-4rem'}}>Se connecter</h2>
      <h5 style={{marginLeft:'8rem', marginBottom:'2rem'}}>Vous avez le choix entre un compte parent ou eleve.</h5>
   ...
   <Link as={Link} to="/Login_parent">
    ...
    <Card border="info" style={{ width: '13rem', backgroundColor:'#0CC0DF', marginLeft:'2rem',marginRight:'2rem' }}>
    <Figure>
        <Link as={Link} to="/Login_eleve">
      <Figure.Image
      style={{marginLeft:'1rem', marginTop:'1rem'}}
        width={171}
        height={180}
    ...
    <Card border="info" style={{ width: '13rem', backgroundColor:'#0CC0DF' }}>
   <Figure>
   <Link as={Link} to="/Login_Enseignant">
      <Figure.Image
      style={{marginLeft:'1rem', marginTop:'1rem'}}
        ...
        src={require("../image/parent.png")}
      /><br/>
      <Button variant="light" style={{backgroundColor:'white', marginLeft:'3rem',marginTop:'2rem', color:'#0CC0DF'}} >Enseignant</Button>
      </Link>
      <Card.Text style={{color:'white',marginLeft:'1rem' , textDecoration: 'none', marginTop:'1rem'}}>
      Le compte parental vous permet de contrôler les progrès scolaires de l'enfant 
      </Card.Text>
